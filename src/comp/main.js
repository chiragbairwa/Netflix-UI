   ...
   return (
      <div className="main">
         ...
         <div className="parties_view">
            ...
            <div className="parties_corousals">
               <PartiesCard title="Cadaver" genre="Horror marathon" />
               <PartiesCard title="Bladerunner" genre="sci fi binge" />
               <PartiesCard title="Bladerunner" genre="sci fi binge" />
               <PartiesCard title="Bladerunner" genre="sci fi binge" />
               <PartiesCard title="Bladerunner" genre="sci fi binge" />
            </div>
         ...
         {/* Continue watching */}
         <div className="watch_view">
            <h2>Continue watching</h2>

            <div className="watch_corousals">
               <WatchingCard title="Cadaver" />
               <WatchingCard title="Bladerunner" />
               <WatchingCard title="Bladerunner" />
               <WatchingCard title="Bladerunner" />
               <WatchingCard title="Bladerunner" />
            </div>
